...
class SKUInfoView(ListAPIView):
    ...
    # @method_decorator(permission_required('goods.Goods_Sku', raise_exception=True))
...
class GoodsSpecificationView(APIView):
    ...
    # @method_decorator(permission_required('goods.Goods_Specification', raise_exception=True))
